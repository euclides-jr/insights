...
// vi.resetAllMocks() clears recorded calls AND removes any mockReturnValue /
// mockResolvedValue implementations set in a previous test, so tests stay
// fully isolated from one another. This is the Vitest equivalent of
// jest-mock-extended's mockReset(prismaMock).
